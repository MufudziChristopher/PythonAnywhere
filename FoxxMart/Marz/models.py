...
class MarzCustomer(models.Model):
...
class Product(models.Model):
    ...
    image5              = models.ImageField(upload_to='main_product/', blank=True, null=False)
    price               = models.DecimalField(max_digits=10, decimal_places=2, null=False)
...
class Order(models.Model):
    ...
    customer = models.ForeignKey(MarzCustomer, on_delete=models.SET_NULL, blank=True, null=True)
